...
// CreateClientWithCert creates a TLS secured connection
func CreateClientWithCert(hostname, CACert, TLSCert, TLSKey string) (api.HeartbeatServiceClient, error) {
	...
	client := api.NewHeartbeatServiceClient(grpcClient)
