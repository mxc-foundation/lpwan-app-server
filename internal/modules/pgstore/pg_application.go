...
func (ps *pgstore) CreateApplication(ctx context.Context, item *store.Application) error {
...
func (ps *pgstore) GetApplication(ctx context.Context, id int64) (store.Application, error) {
...
func (ps *pgstore) GetApplicationCount(ctx context.Context, filters store.ApplicationFilters) (int, error) {
	if filters.Search != "" {
...
func (ps *pgstore) GetApplications(ctx context.Context, filters store.ApplicationFilters) ([]store.ApplicationListItem, error) {
	if filters.Search != "" {
		filters.Search = "%" + filters.Search + "%"
	}
...
func (ps *pgstore) UpdateApplication(ctx context.Context, item store.Application) error {
	if err := item.Validate(); err != nil {
