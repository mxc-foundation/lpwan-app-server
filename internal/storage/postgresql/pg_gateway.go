...
type gatewayTableHandler struct{}

var GatewayTable gatewayTableHandler

func (*gatewayTableHandler) AddGatewayFirmware(db sqlx.Queryer, gwFw *gwmod.GatewayFirmware) (model string, err error) {
	err = db.QueryRowx(`
...
func (*gatewayTableHandler) GetGatewayFirmware(db sqlx.Queryer, model string, forUpdate bool) (gwFw gwmod.GatewayFirmware, err error) {
	var fu string
	if forUpdate {
		fu = " for update"
	}
...
func (*gatewayTableHandler) GetGatewayFirmwareList(db sqlx.Queryer) (list []gwmod.GatewayFirmware, err error) {
	res, err := db.Query(`
		select 
			model, 
			resource_link, 
...
func (*gatewayTableHandler) UpdateGatewayFirmware(db sqlx.Queryer, gwFw *gwmod.GatewayFirmware) (model string, err error) {
	err = db.QueryRowx(`
		update 
		    gateway_firmware 
		set 
...
func (*gatewayTableHandler) UpdateGatewayConfigByGwId(ctx context.Context, db sqlx.Ext, config string, mac lorawan.EUI64) error {
	res, err := db.Exec(`
		update gateway
			set config = $1
		where
...
func (*gatewayTableHandler) CreateGateway(ctx context.Context, db sqlx.Ext, gw *gwmod.Gateway) error {
...
func (*gatewayTableHandler) UpdateGateway(ctx context.Context, db sqlx.Ext, gw *gwmod.Gateway) error {
	if err := gw.Validate(); err != nil {
		return errors.Wrap(err, "validate error")
	}
...
func (*gatewayTableHandler) UpdateFirstHeartbeat(ctx context.Context, db sqlx.Ext, mac lorawan.EUI64, time int64) error {
	res, err := db.Exec(`
		update gateway
...
func (*gatewayTableHandler) UpdateLastHeartbeat(ctx context.Context, db sqlx.Ext, mac lorawan.EUI64, time int64) error {
	res, err := db.Exec(`
		update gateway
...
func (*gatewayTableHandler) SetAutoUpdateFirmware(ctx context.Context, db sqlx.Ext, mac lorawan.EUI64, autoUpdateFirmware bool) error {
	res, err := db.Exec(`
		update gateway
...
func (*gatewayTableHandler) DeleteGateway(ctx context.Context, db sqlx.Ext, mac lorawan.EUI64) error {
	n, err := storage.GetNetworkServerForGatewayMAC(ctx, db, mac)
	if err != nil {
		return errors.Wrap(err, "get network-server error")
	}

	// if the gateway is MatchX gateway, unregister it from provisioning server
	obj, err := GatewayTable.GetGateway(ctx, db, mac, false)
	if err != nil {
...
func (*gatewayTableHandler) GetGateway(ctx context.Context, db sqlx.Queryer, mac lorawan.EUI64, forUpdate bool) (gwmod.Gateway, error) {
	var fu string
	if forUpdate {
		fu = " for update"
	}
...
func (*gatewayTableHandler) GetGatewayCount(ctx context.Context, db sqlx.Queryer, search string) (int, error) {
	var count int
	if search != "" {
		search = "%" + search + "%"
	}
...
func (*gatewayTableHandler) GetGateways(ctx context.Context, db sqlx.Queryer, limit, offset int, search string) ([]gwmod.Gateway, error) {
...
func (*gatewayTableHandler) GetGatewayConfigByGwId(ctx context.Context, db sqlx.Queryer, mac lorawan.EUI64) (string, error) {
	var gwConfig string
...
func (*gatewayTableHandler) GetFirstHeartbeat(ctx context.Context, db sqlx.Queryer, mac lorawan.EUI64) (int64, error) {
...
func (*gatewayTableHandler) UpdateFirstHeartbeatToZero(ctx context.Context, db sqlx.Execer, mac lorawan.EUI64) error {
	res, err := db.Exec(`
		update gateway
...
func (*gatewayTableHandler) GetLastHeartbeat(ctx context.Context, db sqlx.Queryer, mac lorawan.EUI64) (int64, error) {
...
func (*gatewayTableHandler) GetGatewayMiningList(ctx context.Context, db sqlx.Queryer, time, limit int64) ([]lorawan.EUI64, error) {
...
func (*gatewayTableHandler) GetGatewaysLoc(ctx context.Context, db sqlx.Queryer, limit int) ([]gwmod.GatewayLocation, error) {
...
func (*gatewayTableHandler) GetGatewaysForMACs(ctx context.Context, db sqlx.Queryer, macs []lorawan.EUI64) (map[lorawan.EUI64]gwmod.Gateway, error) {
...
func (*gatewayTableHandler) GetGatewayCountForOrganizationID(ctx context.Context, db sqlx.Queryer, organizationID int64, search string) (int, error) {
	var count int
	if search != "" {
		search = "%" + search + "%"
	}
...
func (*gatewayTableHandler) GetGatewaysForOrganizationID(ctx context.Context, db sqlx.Queryer, organizationID int64, limit, offset int, search string) ([]gwmod.Gateway, error) {
	var gws []gwmod.Gateway
	if search != "" {
		search = "%" + search + "%"
	}
...
func (*gatewayTableHandler) GetGatewayCountForUser(ctx context.Context, db sqlx.Queryer, username string, search string) (int, error) {
	var count int
	if search != "" {
		search = "%" + search + "%"
	}
...
// given user has access.
func (*gatewayTableHandler) GetGatewaysForUser(ctx context.Context, db sqlx.Queryer, username string, limit, offset int, search string) ([]gwmod.Gateway, error) {
	var gws []gwmod.Gateway
	if search != "" {
		search = "%" + search + "%"
	}
...
func (*gatewayTableHandler) CreateGatewayPing(ctx context.Context, db sqlx.Queryer, ping *gwmod.GatewayPing) error {
...
func (*gatewayTableHandler) GetGatewayPing(ctx context.Context, db sqlx.Queryer, id int64) (gwmod.GatewayPing, error) {
...
func (*gatewayTableHandler) CreateGatewayPingRX(ctx context.Context, db sqlx.Queryer, rx *gwmod.GatewayPingRX) error {
...
// organization id.
func (*gatewayTableHandler) DeleteAllGatewaysForOrganizationID(ctx context.Context, db sqlx.Ext, organizationID int64) error {
	var gws []gwmod.Gateway
	...
	for _, gw := range gws {
		err = GatewayTable.DeleteGateway(ctx, db, gw.MAC)
		if err != nil {
			return errors.Wrap(err, "delete gateway error")
		}
	}
...
func (*gatewayTableHandler) GetAllGatewayMacList(ctx context.Context, db sqlx.Ext) ([]string, error) {
...
// ping ID.
func (*gatewayTableHandler) GetGatewayPingRXForPingID(ctx context.Context, db sqlx.Queryer, pingID int64) ([]gwmod.GatewayPingRX, error) {
...
// gateway MAC.
func (*gatewayTableHandler) GetLastGatewayPingAndRX(ctx context.Context, db sqlx.Queryer, mac lorawan.EUI64) (gwmod.GatewayPing, []gwmod.GatewayPingRX, error) {
	gw, err := GatewayTable.GetGateway(ctx, db, mac, false)
	if err != nil {
	...
	ping, err := GatewayTable.GetGatewayPing(ctx, db, *gw.LastPingID)
	if err != nil {
		return gwmod.GatewayPing{}, nil, errors.Wrap(err, "get gateway ping error")
	}

	rx, err := GatewayTable.GetGatewayPingRXForPingID(ctx, db, ping.ID)
	if err != nil {
