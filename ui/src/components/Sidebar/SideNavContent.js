        ...
        <div id="sidebar-menu">
            <ul className="metismenu" id="side-menu">
                ...
                <Admin>
                    ...
                    <li>
                        <Link to="/control-panel/history/" className="waves-effect" aria-expanded="false" onClick={() => props.switchSidebar(SUPERNODE_WALLET)}>
                    ...
                    <li>
                        <Link to="/control-panel/system-settings" className="waves-effect" aria-expanded="false" onClick={() => props.switchSidebar(SUPERNODE_SETTING)}>
