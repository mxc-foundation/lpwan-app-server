    ...
    return(
      <FormControl fullWidth margin="normal">
        ...
        <AESKeyField
          ...
          onChange={this.onChange}
          helperText="The fine-timestamp AES decryption key. When set, LPWAN Server will decrypt the fine-timestamp. This is only available for v2 gateways with geolocation capabilities. (optional)"
          fullWidth
        />
      </FormControl>
    );
    ...
    return(
      ...
      >
        ...
        <FormGroup>
          ...
          />
          <FormHelperText>
            When enabled (and LPWAN Server is configured with the gateway discover feature enabled), the gateway will send out periodical pings to test its coverage by other gateways in the same network.
          </FormHelperText>
        </FormGroup>
        <TextField
