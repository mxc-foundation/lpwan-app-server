...
type GetMiningInfoResponse struct {
	MiningIncome         float64       `protobuf:"fixed64,1,opt,name=mining_income,json=miningIncome,proto3" json:"mining_income,omitempty"`
	MiningData           []*MiningData `protobuf:"bytes,2,rep,name=mining_data,json=miningData,proto3" json:"mining_data,omitempty"`
	XXX_NoUnkeyedLiteral struct{}      `json:"-"`
	XXX_unrecognized     []byte        `json:"-"`
	XXX_sizecache        int32         `json:"-"`
}
...
func (m *GetMiningInfoResponse) GetMiningIncome() float64 {
	if m != nil {
		return m.MiningIncome
	}
	return 0
...
func (m *GetMiningInfoResponse) GetMiningData() []*MiningData {
	if m != nil {
		return m.MiningData
	}
	return nil
...
var fileDescriptor_b88fd140af4deb6f = []byte{
	...
	,
}
