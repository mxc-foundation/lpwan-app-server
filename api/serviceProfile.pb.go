...
func (m *GetServiceProfileResponse) GetCreatedAt() *google_protobuf1.Timestamp {
	if m != nil {
		return m.CreatedAt
	}
	return nil
...
func (m *GetServiceProfileResponse) GetUpdatedAt() *google_protobuf1.Timestamp {
	if m != nil {
		return m.UpdatedAt
	}
	return nil
...
func (*DeleteServiceProfileRequest) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{5} }
...
func (*ListServiceProfileRequest) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{6} }
...
func (*ServiceProfileListItem) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{7} }
...
func (m *ServiceProfileListItem) GetCreatedAt() *google_protobuf1.Timestamp {
	if m != nil {
		return m.CreatedAt
	}
	return nil
...
func (m *ServiceProfileListItem) GetUpdatedAt() *google_protobuf1.Timestamp {
	if m != nil {
		return m.UpdatedAt
	}
	return nil
...
type ListServiceProfileResponse struct {
	...
	Result     []*ServiceProfileListItem `protobuf:"bytes,2,rep,name=result" json:"result,omitempty"`
}
...
func (*ListServiceProfileResponse) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{8} }
...
type ServiceProfileServiceClient interface {
	...
	Update(ctx context.Context, in *UpdateServiceProfileRequest, opts ...grpc.CallOption) (*google_protobuf2.Empty, error)
	// Delete deletes the service-profile matching the given id.
	Delete(ctx context.Context, in *DeleteServiceProfileRequest, opts ...grpc.CallOption) (*google_protobuf2.Empty, error)
...
func (c *serviceProfileServiceClient) Update(ctx context.Context, in *UpdateServiceProfileRequest, opts ...grpc.CallOption) (*google_protobuf2.Empty, error) {
...
func (c *serviceProfileServiceClient) Delete(ctx context.Context, in *DeleteServiceProfileRequest, opts ...grpc.CallOption) (*google_protobuf2.Empty, error) {
	out := new(google_protobuf2.Empty)
...
type ServiceProfileServiceServer interface {
	...
	// Update updates the given serviceprofile.
	Update(context.Context, *UpdateServiceProfileRequest) (*google_protobuf2.Empty, error)
	// Delete deletes the service-profile matching the given id.
	Delete(context.Context, *DeleteServiceProfileRequest) (*google_protobuf2.Empty, error)
	// List lists the available service-profiles.
