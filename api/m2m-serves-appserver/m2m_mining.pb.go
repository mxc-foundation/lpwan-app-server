...
var file_m2m_mining_proto_rawDesc = []byte{
	...
	0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x70, 0x0a, 0x0d, 0x47, 0x61, 0x74,
	...
	0x61, 0x6d, 0x70, 0x52, 0x08, 0x74, 0x69, 0x6c, 0x6c, 0x44, 0x61, 0x74, 0x65, 0x22, 0x55, 0x0a,
	0x0b, 0x4d, 0x69, 0x6e, 0x69, 0x6e, 0x67, 0x53, 0x74, 0x61, 0x74, 0x73, 0x12, 0x2e, 0x0a, 0x04,
	...
	0x6f, 0x75, 0x6e, 0x74, 0x22, 0x6f, 0x0a, 0x13, 0x4d, 0x69, 0x6e, 0x69, 0x6e, 0x67, 0x53, 0x74,
	...
	0x74, 0x6f, 0x74, 0x61, 0x6c, 0x32, 0xc8, 0x01, 0x0a, 0x0d, 0x4d, 0x69, 0x6e, 0x69, 0x6e, 0x67,
...
var file_m2m_mining_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_m2m_mining_proto_goTypes = []interface{}{
	(*GatewayMining)(nil),       // 0: m2m_serves_appserver.GatewayMining
	(*MiningRequest)(nil),       // 1: m2m_serves_appserver.MiningRequest
	(*MiningResponse)(nil),      // 2: m2m_serves_appserver.MiningResponse
	(*MiningStatsRequest)(nil),  // 3: m2m_serves_appserver.MiningStatsRequest
	(*MiningStats)(nil),         // 4: m2m_serves_appserver.MiningStats
	(*MiningStatsResponse)(nil), // 5: m2m_serves_appserver.MiningStatsResponse
	(*timestamp.Timestamp)(nil), // 6: google.protobuf.Timestamp
}
var file_m2m_mining_proto_depIdxs = []int32{
	0, // 0: m2m_serves_appserver.MiningRequest.gateway_mining:type_name -> m2m_serves_appserver.GatewayMining
	6, // 1: m2m_serves_appserver.MiningStatsRequest.from_date:type_name -> google.protobuf.Timestamp
	6, // 2: m2m_serves_appserver.MiningStatsRequest.till_date:type_name -> google.protobuf.Timestamp
	6, // 3: m2m_serves_appserver.MiningStats.date:type_name -> google.protobuf.Timestamp
	4, // 4: m2m_serves_appserver.MiningStatsResponse.daily_stats:type_name -> m2m_serves_appserver.MiningStats
	1, // 5: m2m_serves_appserver.MiningService.Mining:input_type -> m2m_serves_appserver.MiningRequest
	3, // 6: m2m_serves_appserver.MiningService.MiningStats:input_type -> m2m_serves_appserver.MiningStatsRequest
	2, // 7: m2m_serves_appserver.MiningService.Mining:output_type -> m2m_serves_appserver.MiningResponse
	5, // 8: m2m_serves_appserver.MiningService.MiningStats:output_type -> m2m_serves_appserver.MiningStatsResponse
