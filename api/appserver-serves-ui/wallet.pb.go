...
var file_wallet_proto_rawDesc = []byte{
	...
	0x6c, 0x44, 0x61, 0x74, 0x65, 0x22, 0x55, 0x0a, 0x0b, 0x4d, 0x69, 0x6e, 0x69, 0x6e, 0x67, 0x53,
	0x74, 0x61, 0x74, 0x73, 0x12, 0x2e, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x65, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x62, 0x75, 0x66, 0x2e, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x52, 0x04,
	0x64, 0x61, 0x74, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x79, 0x0a, 0x1e,
	...
	0x52, 0x02, 0x74, 0x78, 0x32, 0xf3, 0x0a, 0x0a, 0x0d, 0x57, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x53,
	...
	0x6e, 0x69, 0x6e, 0x67, 0x5f, 0x69, 0x6e, 0x63, 0x6f, 0x6d, 0x65, 0x5f, 0x67, 0x77, 0x12, 0x87,
	0x01, 0x0a, 0x0d, 0x47, 0x65, 0x74, 0x4d, 0x69, 0x6e, 0x69, 0x6e, 0x67, 0x49, 0x6e, 0x66, 0x6f,
	0x12, 0x29, 0x2e, 0x61, 0x70, 0x70, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x5f, 0x73, 0x65, 0x72,
	0x76, 0x65, 0x73, 0x5f, 0x75, 0x69, 0x2e, 0x47, 0x65, 0x74, 0x4d, 0x69, 0x6e, 0x69, 0x6e, 0x67,
	0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x2a, 0x2e, 0x61, 0x70,
	0x70, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x65, 0x73, 0x5f, 0x75,
	...
	0x17, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x77, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x2f, 0x6d, 0x69, 0x6e,
	0x69, 0x6e, 0x67, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x12, 0x7f, 0x0a, 0x0b, 0x47, 0x65, 0x74, 0x4d,
...
var file_wallet_proto_msgTypes = make([]protoimpl.MessageInfo, 23)
var file_wallet_proto_goTypes = []interface{}{
	...
	(*GetGatewayMiningIncomeRequest)(nil),  // 4: appserver_serves_ui.GetGatewayMiningIncomeRequest
	(*MiningStats)(nil),                    // 5: appserver_serves_ui.MiningStats
	(*GetGatewayMiningIncomeResponse)(nil), // 6: appserver_serves_ui.GetGatewayMiningIncomeResponse
	(*MiningData)(nil),                     // 7: appserver_serves_ui.MiningData
	(*GetMiningInfoRequest)(nil),           // 8: appserver_serves_ui.GetMiningInfoRequest
	(*GetMiningInfoResponse)(nil),          // 9: appserver_serves_ui.GetMiningInfoResponse
	(*GetVmxcTxHistoryRequest)(nil),        // 10: appserver_serves_ui.GetVmxcTxHistoryRequest
	(*VmxcTxHistory)(nil),                  // 11: appserver_serves_ui.VmxcTxHistory
	(*GetVmxcTxHistoryResponse)(nil),       // 12: appserver_serves_ui.GetVmxcTxHistoryResponse
	(*GetNetworkUsageHistRequest)(nil),     // 13: appserver_serves_ui.GetNetworkUsageHistRequest
	(*NetworkUsage)(nil),                   // 14: appserver_serves_ui.NetworkUsage
	(*GetNetworkUsageHistResponse)(nil),    // 15: appserver_serves_ui.GetNetworkUsageHistResponse
	(*GetDownLinkPriceRequest)(nil),        // 16: appserver_serves_ui.GetDownLinkPriceRequest
	(*GetDownLinkPriceResponse)(nil),       // 17: appserver_serves_ui.GetDownLinkPriceResponse
	(*GetMXCpriceRequest)(nil),             // 18: appserver_serves_ui.GetMXCpriceRequest
	(*GetMXCpriceResponse)(nil),            // 19: appserver_serves_ui.GetMXCpriceResponse
	(*GetTransactionHistoryRequest)(nil),   // 20: appserver_serves_ui.GetTransactionHistoryRequest
	(*Transaction)(nil),                    // 21: appserver_serves_ui.Transaction
	(*GetTransactionHistoryResponse)(nil),  // 22: appserver_serves_ui.GetTransactionHistoryResponse
	(*timestamp.Timestamp)(nil),            // 23: google.protobuf.Timestamp
}
var file_wallet_proto_depIdxs = []int32{
	23, // 0: appserver_serves_ui.GetWalletMiningIncomeRequest.from:type_name -> google.protobuf.Timestamp
	23, // 1: appserver_serves_ui.GetWalletMiningIncomeRequest.till:type_name -> google.protobuf.Timestamp
	23, // 2: appserver_serves_ui.GetGatewayMiningIncomeRequest.from_date:type_name -> google.protobuf.Timestamp
	23, // 3: appserver_serves_ui.GetGatewayMiningIncomeRequest.till_date:type_name -> google.protobuf.Timestamp
	23, // 4: appserver_serves_ui.MiningStats.date:type_name -> google.protobuf.Timestamp
	5,  // 5: appserver_serves_ui.GetGatewayMiningIncomeResponse.daily_stats:type_name -> appserver_serves_ui.MiningStats
	7,  // 6: appserver_serves_ui.GetMiningInfoResponse.data:type_name -> appserver_serves_ui.MiningData
	11, // 7: appserver_serves_ui.GetVmxcTxHistoryResponse.tx_history:type_name -> appserver_serves_ui.VmxcTxHistory
	23, // 8: appserver_serves_ui.GetNetworkUsageHistRequest.from:type_name -> google.protobuf.Timestamp
	23, // 9: appserver_serves_ui.GetNetworkUsageHistRequest.till:type_name -> google.protobuf.Timestamp
	23, // 10: appserver_serves_ui.NetworkUsage.timestamp:type_name -> google.protobuf.Timestamp
	14, // 11: appserver_serves_ui.GetNetworkUsageHistResponse.network_usage:type_name -> appserver_serves_ui.NetworkUsage
	23, // 12: appserver_serves_ui.GetTransactionHistoryRequest.from:type_name -> google.protobuf.Timestamp
	23, // 13: appserver_serves_ui.GetTransactionHistoryRequest.till:type_name -> google.protobuf.Timestamp
	23, // 14: appserver_serves_ui.Transaction.timestamp:type_name -> google.protobuf.Timestamp
	21, // 15: appserver_serves_ui.GetTransactionHistoryResponse.tx:type_name -> appserver_serves_ui.Transaction
	0,  // 16: appserver_serves_ui.WalletService.GetWalletBalance:input_type -> appserver_serves_ui.GetWalletBalanceRequest
	10, // 17: appserver_serves_ui.WalletService.GetVmxcTxHistory:input_type -> appserver_serves_ui.GetVmxcTxHistoryRequest
	13, // 18: appserver_serves_ui.WalletService.GetNetworkUsageHist:input_type -> appserver_serves_ui.GetNetworkUsageHistRequest
	16, // 19: appserver_serves_ui.WalletService.GetDlPrice:input_type -> appserver_serves_ui.GetDownLinkPriceRequest
	2,  // 20: appserver_serves_ui.WalletService.GetWalletMiningIncome:input_type -> appserver_serves_ui.GetWalletMiningIncomeRequest
	4,  // 21: appserver_serves_ui.WalletService.GetGatewayMiningIncome:input_type -> appserver_serves_ui.GetGatewayMiningIncomeRequest
	8,  // 22: appserver_serves_ui.WalletService.GetMiningInfo:input_type -> appserver_serves_ui.GetMiningInfoRequest
	18, // 23: appserver_serves_ui.WalletService.GetMXCprice:input_type -> appserver_serves_ui.GetMXCpriceRequest
	20, // 24: appserver_serves_ui.WalletService.GetTransactionHistory:input_type -> appserver_serves_ui.GetTransactionHistoryRequest
	1,  // 25: appserver_serves_ui.WalletService.GetWalletBalance:output_type -> appserver_serves_ui.GetWalletBalanceResponse
	12, // 26: appserver_serves_ui.WalletService.GetVmxcTxHistory:output_type -> appserver_serves_ui.GetVmxcTxHistoryResponse
	15, // 27: appserver_serves_ui.WalletService.GetNetworkUsageHist:output_type -> appserver_serves_ui.GetNetworkUsageHistResponse
	17, // 28: appserver_serves_ui.WalletService.GetDlPrice:output_type -> appserver_serves_ui.GetDownLinkPriceResponse
	3,  // 29: appserver_serves_ui.WalletService.GetWalletMiningIncome:output_type -> appserver_serves_ui.GetWalletMiningIncomeResponse
	6,  // 30: appserver_serves_ui.WalletService.GetGatewayMiningIncome:output_type -> appserver_serves_ui.GetGatewayMiningIncomeResponse
	9,  // 31: appserver_serves_ui.WalletService.GetMiningInfo:output_type -> appserver_serves_ui.GetMiningInfoResponse
	19, // 32: appserver_serves_ui.WalletService.GetMXCprice:output_type -> appserver_serves_ui.GetMXCpriceResponse
	22, // 33: appserver_serves_ui.WalletService.GetTransactionHistory:output_type -> appserver_serves_ui.GetTransactionHistoryResponse
