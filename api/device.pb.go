...
type Device struct {
	...
	DeviceProfileId string `protobuf:"bytes,5,opt,name=device_profile_id,json=deviceProfileID" json:"device_profile_id,omitempty"`
	// Skip frame-counter checks (this is insecure, but could be helpful for debugging).
	SkipFCntCheck bool `protobuf:"varint,6,opt,name=skip_f_cnt_check,json=skipFCntCheck" json:"skip_f_cnt_check,omitempty"`
	// Reference altitude.
	...
	// accuracy.
	ReferenceAltitude float64 `protobuf:"fixed64,7,opt,name=reference_altitude,json=referenceAltitude" json:"reference_altitude,omitempty"`
	// Variables (user defined).
	// These variables can be used together with integrations to store tokens /
	// secrets that must be configured per device. These variables are not
	// exposed in the event payloads.
	Variables map[string]string `protobuf:"bytes,8,rep,name=variables" json:"variables,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	// Tags (user defined).
...
type DeviceListItem struct {
	...
	DeviceProfileId string `protobuf:"bytes,5,opt,name=device_profile_id,json=deviceProfileID" json:"device_profile_id,omitempty"`
	// Device-profile name.
	DeviceProfileName string `protobuf:"bytes,6,opt,name=device_profile_name,json=deviceProfileName" json:"device_profile_name,omitempty"`
	...
	DeviceStatusBattery uint32 `protobuf:"varint,7,opt,name=device_status_battery,json=deviceStatusBattery" json:"device_status_battery,omitempty"`
	// The device margin status
	// -32..32: The demodulation SNR ration in dB
	// 256:     The device-status is not available.
	DeviceStatusMargin int32 `protobuf:"varint,8,opt,name=device_status_margin,json=deviceStatusMargin" json:"device_status_margin,omitempty"`
	// Device is connected to an external power source.
	DeviceStatusExternalPowerSource bool `protobuf:"varint,10,opt,name=device_status_external_power_source,json=deviceStatusExternalPowerSource" json:"device_status_external_power_source,omitempty"`
	// Device battery status is unavailable.
	DeviceStatusBatteryLevelUnavailable bool `protobuf:"varint,11,opt,name=device_status_battery_level_unavailable,json=deviceStatusBatteryLevelUnavailable" json:"device_status_battery_level_unavailable,omitempty"`
	// Device battery level as a percentage.
	DeviceStatusBatteryLevel float32 `protobuf:"fixed32,12,opt,name=device_status_battery_level,json=deviceStatusBatteryLevel" json:"device_status_battery_level,omitempty"`
...
func (*DeviceListItem) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{1} }
...
func (m *DeviceListItem) GetLastSeenAt() *google_protobuf1.Timestamp {
	if m != nil {
		return m.LastSeenAt
	}
	return nil
...
type DeviceKeys struct {
	...
	NwkKey string `protobuf:"bytes,2,opt,name=nwk_key,json=nwkKey" json:"nwk_key,omitempty"`
	...
	GenAppKey string `protobuf:"bytes,4,opt,name=gen_app_key,json=genAppKey" json:"gen_app_key,omitempty"`
}
...
func (*DeviceKeys) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{2} }
...
func (*GetDeviceRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{4} }
...
type GetDeviceResponse struct {
	...
	// 255:    The end-device was not able to measure the battery level
	// 256:    The device-status is not available.
	DeviceStatusBattery uint32 `protobuf:"varint,6,opt,name=device_status_battery,json=deviceStatusBattery" json:"device_status_battery,omitempty"`
	// The device margin status
	// -32..32: The demodulation SNR ration in dB
	// 256:     The device-status is not available.
	DeviceStatusMargin int32 `protobuf:"varint,20,opt,name=device_status_margin,json=deviceStatusMargin" json:"device_status_margin,omitempty"`
	// Device location.
	// This will set when the network-server was able to resolve the location
	// using the geolocation-server.
	Location *common.Location `protobuf:"bytes,21,opt,name=location" json:"location,omitempty"`
}
...
func (*GetDeviceResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{5} }
...
func (m *GetDeviceResponse) GetLastSeenAt() *google_protobuf1.Timestamp {
	if m != nil {
		return m.LastSeenAt
	}
	return nil
...
type ListDeviceRequest struct {
	...
	MulticastGroupId string `protobuf:"bytes,5,opt,name=multicast_group_id,json=multicastGroupID" json:"multicast_group_id,omitempty"`
	// Service-profile ID to filter on (string formatted UUID).
	ServiceProfileId string `protobuf:"bytes,6,opt,name=service_profile_id,json=serviceProfileID" json:"service_profile_id,omitempty"`
}
...
func (*ListDeviceRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{6} }
...
func (*ListDeviceResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{7} }
...
type CreateDeviceKeysRequest struct {
	...
	DeviceKeys *DeviceKeys `protobuf:"bytes,1,opt,name=device_keys,json=deviceKeys" json:"device_keys,omitempty"`
}
...
func (*CreateDeviceKeysRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{10} }
...
func (*GetDeviceKeysRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{11} }
...
func (*GetDeviceKeysResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{12} }
...
func (*UpdateDeviceKeysRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{13} }
...
func (*DeleteDeviceKeysRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{14} }
...
type DeviceActivation struct {
	...
	AppSKey string `protobuf:"bytes,3,opt,name=app_s_key,json=appSKey" json:"app_s_key,omitempty"`
	// Network session encryption key (HEX encoded).
	NwkSEncKey string `protobuf:"bytes,4,opt,name=nwk_s_enc_key,json=nwkSEncKey" json:"nwk_s_enc_key,omitempty"`
	// Serving network session integrity key (HEX encoded).
	SNwkSIntKey string `protobuf:"bytes,8,opt,name=s_nwk_s_int_key,json=sNwkSIntKey" json:"s_nwk_s_int_key,omitempty"`
	// Forwarding network session integrity key (HEX encoded).
	FNwkSIntKey string `protobuf:"bytes,9,opt,name=f_nwk_s_int_key,json=fNwkSIntKey" json:"f_nwk_s_int_key,omitempty"`
	// Uplink frame-counter.
	FCntUp uint32 `protobuf:"varint,5,opt,name=f_cnt_up,json=fCntUp" json:"f_cnt_up,omitempty"`
	// Downlink network frame-counter.
	NFCntDown uint32 `protobuf:"varint,6,opt,name=n_f_cnt_down,json=nFCntDown" json:"n_f_cnt_down,omitempty"`
	// Downlink application frame-counter.
	AFCntDown uint32 `protobuf:"varint,10,opt,name=a_f_cnt_down,json=aFCntDown" json:"a_f_cnt_down,omitempty"`
}
...
func (*DeviceActivation) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{15} }
...
func (*ActivateDeviceRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{16} }
...
func (*DeactivateDeviceRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{17} }
...
func (*GetDeviceActivationRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{18} }
...
func (*GetDeviceActivationResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{19} }
...
func (*GetRandomDevAddrRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{20} }
...
type GetRandomDevAddrResponse struct {
	// Device address (HEX encoded).
	DevAddr string `protobuf:"bytes,1,opt,name=dev_addr,json=devAddr" json:"dev_addr,omitempty"`
}
...
func (*GetRandomDevAddrResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{21} }
...
func (*StreamDeviceFrameLogsRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{22} }
...
func (*StreamDeviceFrameLogsResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{23} }

type isStreamDeviceFrameLogsResponse_Frame interface{ isStreamDeviceFrameLogsResponse_Frame() }
...
func (*StreamDeviceEventLogsRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{24} }
...
type StreamDeviceEventLogsResponse struct {
	...
	PayloadJson string `protobuf:"bytes,2,opt,name=payload_json,json=payloadJSON" json:"payload_json,omitempty"`
}
...
func (*StreamDeviceEventLogsResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{25} }
...
type DeviceServiceClient interface {
	...
	Create(ctx context.Context, in *CreateDeviceRequest, opts ...grpc.CallOption) (*google_protobuf2.Empty, error)
	...
	Delete(ctx context.Context, in *DeleteDeviceRequest, opts ...grpc.CallOption) (*google_protobuf2.Empty, error)
	// Update updates the device matching the given DevEUI.
	Update(ctx context.Context, in *UpdateDeviceRequest, opts ...grpc.CallOption) (*google_protobuf2.Empty, error)
	// CreateKeys creates the given device-keys.
	CreateKeys(ctx context.Context, in *CreateDeviceKeysRequest, opts ...grpc.CallOption) (*google_protobuf2.Empty, error)
	...
	UpdateKeys(ctx context.Context, in *UpdateDeviceKeysRequest, opts ...grpc.CallOption) (*google_protobuf2.Empty, error)
	// DeleteKeys deletes the device-keys for the given DevEUI.
	DeleteKeys(ctx context.Context, in *DeleteDeviceKeysRequest, opts ...grpc.CallOption) (*google_protobuf2.Empty, error)
	// Activate (re)activates the device (only when ABP is set to true).
	Activate(ctx context.Context, in *ActivateDeviceRequest, opts ...grpc.CallOption) (*google_protobuf2.Empty, error)
	// Deactivate de-activates the device.
	Deactivate(ctx context.Context, in *DeactivateDeviceRequest, opts ...grpc.CallOption) (*google_protobuf2.Empty, error)
...
func (c *deviceServiceClient) Create(ctx context.Context, in *CreateDeviceRequest, opts ...grpc.CallOption) (*google_protobuf2.Empty, error) {
	out := new(google_protobuf2.Empty)
	err := grpc.Invoke(ctx, "/api.DeviceService/Create", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *deviceServiceClient) Get(ctx context.Context, in *GetDeviceRequest, opts ...grpc.CallOption) (*GetDeviceResponse, error) {
	...
	err := grpc.Invoke(ctx, "/api.DeviceService/Get", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *deviceServiceClient) List(ctx context.Context, in *ListDeviceRequest, opts ...grpc.CallOption) (*ListDeviceResponse, error) {
	...
	err := grpc.Invoke(ctx, "/api.DeviceService/List", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *deviceServiceClient) Delete(ctx context.Context, in *DeleteDeviceRequest, opts ...grpc.CallOption) (*google_protobuf2.Empty, error) {
	out := new(google_protobuf2.Empty)
	err := grpc.Invoke(ctx, "/api.DeviceService/Delete", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *deviceServiceClient) Update(ctx context.Context, in *UpdateDeviceRequest, opts ...grpc.CallOption) (*google_protobuf2.Empty, error) {
	out := new(google_protobuf2.Empty)
	err := grpc.Invoke(ctx, "/api.DeviceService/Update", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *deviceServiceClient) CreateKeys(ctx context.Context, in *CreateDeviceKeysRequest, opts ...grpc.CallOption) (*google_protobuf2.Empty, error) {
	out := new(google_protobuf2.Empty)
	err := grpc.Invoke(ctx, "/api.DeviceService/CreateKeys", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *deviceServiceClient) GetKeys(ctx context.Context, in *GetDeviceKeysRequest, opts ...grpc.CallOption) (*GetDeviceKeysResponse, error) {
	...
	err := grpc.Invoke(ctx, "/api.DeviceService/GetKeys", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *deviceServiceClient) UpdateKeys(ctx context.Context, in *UpdateDeviceKeysRequest, opts ...grpc.CallOption) (*google_protobuf2.Empty, error) {
	out := new(google_protobuf2.Empty)
	err := grpc.Invoke(ctx, "/api.DeviceService/UpdateKeys", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *deviceServiceClient) DeleteKeys(ctx context.Context, in *DeleteDeviceKeysRequest, opts ...grpc.CallOption) (*google_protobuf2.Empty, error) {
	out := new(google_protobuf2.Empty)
	err := grpc.Invoke(ctx, "/api.DeviceService/DeleteKeys", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *deviceServiceClient) Activate(ctx context.Context, in *ActivateDeviceRequest, opts ...grpc.CallOption) (*google_protobuf2.Empty, error) {
	out := new(google_protobuf2.Empty)
	err := grpc.Invoke(ctx, "/api.DeviceService/Activate", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *deviceServiceClient) Deactivate(ctx context.Context, in *DeactivateDeviceRequest, opts ...grpc.CallOption) (*google_protobuf2.Empty, error) {
	out := new(google_protobuf2.Empty)
	err := grpc.Invoke(ctx, "/api.DeviceService/Deactivate", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *deviceServiceClient) GetActivation(ctx context.Context, in *GetDeviceActivationRequest, opts ...grpc.CallOption) (*GetDeviceActivationResponse, error) {
	...
	err := grpc.Invoke(ctx, "/api.DeviceService/GetActivation", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *deviceServiceClient) GetRandomDevAddr(ctx context.Context, in *GetRandomDevAddrRequest, opts ...grpc.CallOption) (*GetRandomDevAddrResponse, error) {
	...
	err := grpc.Invoke(ctx, "/api.DeviceService/GetRandomDevAddr", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *deviceServiceClient) StreamFrameLogs(ctx context.Context, in *StreamDeviceFrameLogsRequest, opts ...grpc.CallOption) (DeviceService_StreamFrameLogsClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_DeviceService_serviceDesc.Streams[0], c.cc, "/api.DeviceService/StreamFrameLogs", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *deviceServiceClient) StreamEventLogs(ctx context.Context, in *StreamDeviceEventLogsRequest, opts ...grpc.CallOption) (DeviceService_StreamEventLogsClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_DeviceService_serviceDesc.Streams[1], c.cc, "/api.DeviceService/StreamEventLogs", opts...)
	if err != nil {
		return nil, err
	}
...
type DeviceServiceServer interface {
	// Create creates the given device.
	Create(context.Context, *CreateDeviceRequest) (*google_protobuf2.Empty, error)
	// Get returns the device matching the given DevEUI.
	...
	// Delete deletes the device matching the given DevEUI.
	Delete(context.Context, *DeleteDeviceRequest) (*google_protobuf2.Empty, error)
	// Update updates the device matching the given DevEUI.
	Update(context.Context, *UpdateDeviceRequest) (*google_protobuf2.Empty, error)
	// CreateKeys creates the given device-keys.
	CreateKeys(context.Context, *CreateDeviceKeysRequest) (*google_protobuf2.Empty, error)
	// GetKeys returns the device-keys for the given DevEUI.
	GetKeys(context.Context, *GetDeviceKeysRequest) (*GetDeviceKeysResponse, error)
	// UpdateKeys updates the device-keys.
	UpdateKeys(context.Context, *UpdateDeviceKeysRequest) (*google_protobuf2.Empty, error)
	// DeleteKeys deletes the device-keys for the given DevEUI.
	DeleteKeys(context.Context, *DeleteDeviceKeysRequest) (*google_protobuf2.Empty, error)
	// Activate (re)activates the device (only when ABP is set to true).
	Activate(context.Context, *ActivateDeviceRequest) (*google_protobuf2.Empty, error)
	// Deactivate de-activates the device.
	Deactivate(context.Context, *DeactivateDeviceRequest) (*google_protobuf2.Empty, error)
	// GetActivation returns the current activation details of the device (OTAA and ABP).
...
var fileDescriptor0 = []byte{
	...
	,
}
