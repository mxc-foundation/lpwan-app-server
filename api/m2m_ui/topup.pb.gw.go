...
var (
	...
	pattern_TopUpService_GetTopUpDestination_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"api", "top-up", "account", "money_abbr"}, "", runtime.AssumeColonVerbOpt(true)))
)
