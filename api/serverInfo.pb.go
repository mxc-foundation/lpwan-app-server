...
func (*GetAppserverVersionResponse) Descriptor() ([]byte, []int) { return fileDescriptor15, []int{0} }
...
// Client API for ServerInfoService service

type ServerInfoServiceClient interface {
	// get version
	GetAppserverVersion(ctx context.Context, in *google_protobuf2.Empty, opts ...grpc.CallOption) (*GetAppserverVersionResponse, error)
}
...
func (c *serverInfoServiceClient) GetAppserverVersion(ctx context.Context, in *google_protobuf2.Empty, opts ...grpc.CallOption) (*GetAppserverVersionResponse, error) {
	out := new(GetAppserverVersionResponse)
	err := grpc.Invoke(ctx, "/api.ServerInfoService/GetAppserverVersion", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// Server API for ServerInfoService service

type ServerInfoServiceServer interface {
	// get version
	GetAppserverVersion(context.Context, *google_protobuf2.Empty) (*GetAppserverVersionResponse, error)
}
...
func _ServerInfoService_GetAppserverVersion_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServerInfoServiceServer).GetAppserverVersion(ctx, req.(*google_protobuf2.Empty))
	}
...
func init() { proto.RegisterFile("serverInfo.proto", fileDescriptor15) }
