...
func local_request_InternalService_GetVerigyingAliyunRecaptcha_0(ctx context.Context, marshaler runtime.Marshaler, server InternalServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq AliyunRecaptchaRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.GetVerigyingAliyunRecaptcha(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterInternalServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server InternalServiceServer) error {
	...
	mux.Handle("POST", pattern_InternalService_GetVerigyingAliyunRecaptcha_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_InternalService_GetVerigyingAliyunRecaptcha_0(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
